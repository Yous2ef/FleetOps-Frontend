...
export const defaultSettingsMockData = {
    general: {
        currency: "EGP",
...
/**
 * Simulates a network delay for API realism
 */
const delay = (ms = 100) => new Promise(resolve => setTimeout(resolve, ms));

/**
 * API: GET /api/settings
 * Retrieves settings from localStorage or defaults
 */
